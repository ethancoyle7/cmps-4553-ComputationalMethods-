...
# importin random to use random integer nodes
from random import randint
# importting the matploylib to display and draw our graph
...
degrees = pd.DataFrame(list(graph_obj.degree()), columns = ("index_name",
                        "degree")).set_index("index_name")
...
# draw the graph with the labels to identify 
nx.draw(graph_obj,with_labels=True)

#show the graph using matplot lib
plt.show()
